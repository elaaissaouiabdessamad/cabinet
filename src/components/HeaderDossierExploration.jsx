...
const HeaderDossierExploration = ({ handleDossierExploration }) => {
  return (
    <div className="flex items-center mb-6 w-full">
      <div className="flex items-center w-full relative">
        <button
          onClick={handleDossierExploration}
          className="mr-4 bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-lg flex items-center"
        >
          <i class="fa fa-angle-double-left"></i>&nbsp; Au exploration
        </button>
        <input
          type="text"
          placeholder="Search..."
...
export default HeaderDossierExploration;
