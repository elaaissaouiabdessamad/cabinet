...
const SalleCatheterisme = () => {
    ...
    try {
      ...
      const filteredAssignments = response.data.flatMap((patient) =>
        patient.roomAssignments
          .filter(
            (assignment) =>
              assignment.roomType === "SALLE_CATHETERISME" &&
  ...
  const fetchDoctorsAndPatients = useCallback(async () => {
    try {
      ...
      console.error(
        "L'erreur lors de la récupération des médecins ou des patients.",
        error
      );
    }
  }, []);
  ...
  return (
    <div className="flex flex-col items-center p-4">
      ...
      <div className="flex items-center justify-between">
        <span className="text-2xl font-bold mt-4">Salle de Cathétérisme</span>
        <button
...
export default SalleCatheterisme;
