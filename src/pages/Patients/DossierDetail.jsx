  ...
  return (
    <div className="p-4 flex">
      <div className="w-full p-6">
        ...
        <h2 className={`text-xl font-bold py-2 ${patientColor}`}>
          Mr Patient &nbsp;
          ...
          <span className="text-sm text-gray-500">
            , Ref : {bed.currentPatient.referenceID}
          </span>
        </h2>
        <div className="grid grid-cols-3 gap-4 mt-4">
          <Link
            ...
            state={{ patient: bed.currentPatient, color: patientColor }}
